...
namespace HostelSQL {
    ...
    public partial class HostelDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_Students_ToTable_1;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_Students_ToTable_1 = this.Relations["FK_Students_ToTable_1"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_Students_ToTable_1 = new global::System.Data.DataRelation("FK_Students_ToTable_1", new global::System.Data.DataColumn[] {
                        this.tableRooms.IdColumn}, new global::System.Data.DataColumn[] {
                        this.tableStudents.RoomNumberColumn}, false);
            this.Relations.Add(this.relationFK_Students_ToTable_1);
        }
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentsRow AddStudentsRow(int Id, string Name, string Gender, string Adress, string Group, string Passport, BenefitsRow parentBenefitsRowByFK_Students_ToTable, RoomsRow parentRoomsRowByFK_Students_ToTable_1, System.DateTime ColonizeDate) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        null,
                        ColonizeDate};
                if ((parentBenefitsRowByFK_Students_ToTable != null)) {
                    columnValuesArray[6] = parentBenefitsRowByFK_Students_ToTable[0];
                }
                if ((parentRoomsRowByFK_Students_ToTable_1 != null)) {
                    columnValuesArray[7] = parentRoomsRowByFK_Students_ToTable_1[0];
                }
        ...
        public partial class RoomsRow : global::System.Data.DataRow {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentsRow[] GetStudentsRows() {
                if ((this.Table.ChildRelations["FK_Students_ToTable_1"] == null)) {
                    return new StudentsRow[0];
                }
                else {
                    return ((StudentsRow[])(base.GetChildRows(this.Table.ChildRelations["FK_Students_ToTable_1"])));
                }
            }
        }
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public BenefitsRow BenefitsRow {
                get {
                    return ((BenefitsRow)(this.GetParentRow(this.Table.ParentRelations["FK_Students_ToTable"])));
                }
                set {
            ...
            public RoomsRow RoomsRow {
                get {
                    return ((RoomsRow)(this.GetParentRow(this.Table.ParentRelations["FK_Students_ToTable_1"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_Students_ToTable_1"]);
                }
            }
        }
...
namespace HostelSQL.HostelDataSetTableAdapters {
    ...
    public partial class BenefitsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HostelSQL.Properties.Settings.Default.HostelConnectionString;
        }
...
SELECT Id, Price, Amount, Floor, Tools FROM Rooms WHERE (Id = @Id)";
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Students] ([Id], [Name], [Gender], [Adress], [Group], [Passport], [BenefitCode], [RoomNumber], [ColonizeDate]) VALUES (@Id, @Name, @Gender, @Adress, @Group, @Passport, @BenefitCode, @RoomNumber, @ColonizeDate);
SELECT Id, Name, Gender, Adress, [Group], Passport, BenefitCode, RoomNumber, ColonizeDate FROM Students WHERE (Id = @Id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@BenefitCode", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "BenefitCode", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ColonizeDate", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ColonizeDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [Id] = @Id, [Name] = @Name, [Gender] = @Gender, [Adress] = @Adress, [Group] = @Group, [Passport] = @Passport, [BenefitCode] = @BenefitCode, [RoomNumber] = @RoomNumber, [ColonizeDate] = @ColonizeDate WHERE (([Id] = @Original_Id) AND ([BenefitCode] = @Original_BenefitCode) AND ([RoomNumber] = @Original_RoomNumber) AND ([ColonizeDate] = @Original_ColonizeDate));
SELECT Id, Name, Gender, Adress, [Group], Passport, BenefitCode, RoomNumber, ColonizeDate FROM Students WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Name, Gender, Adress, [Group], Passport, BenefitCode, RoomNumber, Colo" +
                "nizeDate FROM dbo.Students";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int Id, string Name, string Gender, string Adress, string Group, string Passport, int BenefitCode, int RoomNumber, System.DateTime ColonizeDate) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[8].Value = ((System.DateTime)(ColonizeDate));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.InsertCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, string Name, string Gender, string Adress, string Group, string Passport, int BenefitCode, int RoomNumber, System.DateTime ColonizeDate, int Original_Id, int Original_BenefitCode, int Original_RoomNumber, System.DateTime Original_ColonizeDate) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Gender, string Adress, string Group, string Passport, int BenefitCode, int RoomNumber, System.DateTime ColonizeDate, int Original_Id, int Original_BenefitCode, int Original_RoomNumber, System.DateTime Original_ColonizeDate) {
            return this.Update(Original_Id, Name, Gender, Adress, Group, Passport, BenefitCode, RoomNumber, ColonizeDate, Original_Id, Original_BenefitCode, Original_RoomNumber, Original_ColonizeDate);
        }
    }
